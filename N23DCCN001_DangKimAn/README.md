...
### Naive Bayes
![Ma tran nham lan - Naive Bayes](data/artifacts/naive_algorithm.png)

### Logistic Regression
![Ma tran nham lan - Logistic Regression](data/artifacts/logistic_regression.png)

### SVM (Nystroem)
![Ma tran nham lan - SVM](data/artifacts/svm_v5_confusion_matrix.png)
